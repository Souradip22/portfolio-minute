...
export default function ProfilePage({
  ...
  return (
    <div className="mx-auto flex flex-col justify-between gap-4 px-4 lg:px-8  overflow-y-auto  h-screen pb-8">
      <div
            ...
            return (
              ...
              item.label == "resume" && (
                <a
                  ...
                  href={item.value}
                >
                  <div className="bg-white border border-amber-600 border-dashed flex group-active:border-alpha h-full hover:translate-x-2 hover:translate-y-2  px-6 py-3 text-black text-sm transition-transform w-full z-[2]">
              ...
              {eduExpValues?.map(
                (item: any, index: any) =>
                  item.type === "company" && (
                    <div
                      key={`${index}-company`}
                      className="mt-8 border-grey-100 border-l-2 border-purple-800 dark:border dark:border-zinc-800 rounded-md p-4 w-full relative shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px]"
                    >
            ...
            <div className="grid gap-4 grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 my-2 w-full mt-4">
              {projects &&
                projects.map((item: any, index: any) => (
                  <div
                    className="border-grey-100 border-t-4  border-purple-600  rounded-md p-4 w-full relative shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px]  dark:shadow-blue-500/20"
                    key={`${index}-project`}
                  >
          ...
          <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16  lg:pt-24">
            ...
            <div className="mt-16 border-t border-gray-100 pt-8 sm:flex sm:items-center sm:justify-between">
              ...
              <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
                {socialLinks?.slice(0, 5).map((item: any, index: any) => {
                  return (
                    item.value !== "" &&
                    item.label !== "resume" && (
